...
class PemetaanCPLCPMKMKtest extends DuskTestCase
{
    ...
    public function testViewPemetaan()
    {
        $this->browse(function (Browser $browser) {
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/"
                )
                ->assertSee(
    ...
    public function testTambahSatuCPMK()
    {
        $this->browse(function (Browser $browser) {
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/add_cpmk/CPL01"
                )
                ->assertSee(
                ...
                ->keys(
                    "textarea",
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam posuere magna porta, imperdiet ligula tempor, pulvinar libero. Integer tincidunt ullamcorper nibh, ut feugiat ex luctus pellentesque. Aliquam nec ullamcorper nulla. Proin in placerat libero. Nulla facilisi. Aenean et tincidunt metus."
                )
                ->pause(1000)
                ->press("Kirim")
                ->waitForText("Sukses!")
    ...
    public function testTambahBanyakCPMK()
    {
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/add_cpmk/CPL03"
                )
                ->assertSee(
                    "Input Capaian Pembelajaran Mata Kuliah (CPMK) Berdasarkan Capaian Pembelajaran Lulusan (CPL)"
                )
                ...
                ->keys(
                    "#deskripsi-1",
                    "Lorem ipsum ini testing cpmk yang pertama."
                )
                ->pause(1000)
                ...
                ->keys(
                    "#deskripsi-2",
                    "Lorem ipsum ini testing cpmk yang kedua."
                )
                ->pause(1000)
                ->press("Tambah field CPMK")
                ...
                ->keys(
                    "#deskripsi-3",
                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam posuere magna porta, imperdiet ligula tempor, pulvinar libero ini testing cpmk yang ketiga."
                )
                ->pause(1000)
    ...
    public function testTambahMK()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/add_cpmk/CPL02"
                )
                ->assertSee(
                    "Input Capaian Pembelajaran Mata Kuliah (CPMK) Berdasarkan Capaian Pembelajaran Lulusan (CPL)"
                )
            ...
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/edit_cpmk/CPMK021"
                )
                ->assertSee(
                    "Input Capaian Pembelajaran Mata Kuliah (CPMK) Berdasarkan Capaian Pembelajaran Lulusan (CPL)"
                )
    ...
    public function testEditCPMK()
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/edit_cpmk/CPMK031"
                )
                ->clear("textarea")
    ...
    public function testViewMatriks()
    {
        $this->browse(function (Browser $browser) {
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/kurikulum/pemetaan/cpl-cpmk-mk/matriks"
                )
                ->assertSee(
