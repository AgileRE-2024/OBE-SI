...
class PeranDosenTest extends DuskTestCase
{
    ...
    public function testView(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/rps/edit/peran_dosen/MK0112023"
                )
                // ->pause(60 * 60000);
    ...
    public function testAdd(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/rps/edit/add_peran_dosen/MK0112023"
                )
                // ->pause(60 * 60000);
    ...
    public function testEdit(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser
                ->visit(
                    "http://127.0.0.1:8000/dashboard/rps/edit/edit_peran_dosen/123456789987654323/MK0112023/Dosen%20Pengampu"
                )
                // ->pause(60 * 60000);
    ...
    public function testDelete(): void
    {
        $this->browse(function (Browser $browser) {
            ...
            $browser->pause(1000);
            $browser->driver
                ->findElement(WebDriverBy::cssSelector('a[name="delete"]'))
                ->click();
            $browser->pause(1000);
            // $browser->click('a', 'Edit');
            // $browser->select('select[name="peranDosen"]', 'Dosen Pengampu');
