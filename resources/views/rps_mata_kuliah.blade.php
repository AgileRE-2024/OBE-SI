                ...
                <td scope="row">
                    <div class="table" style="display: flex; flex-direction: column;">
                        ...
                        <div class="table-row mb-2" style="display: flex; border: none">
                            ...
                            <div class="table-cell"><a href="{{ route('edit_rps.edit_komponen_penilaian', ['id_komponen_penilaian' => $item->id_komponen_penilaian, 'kodeRPS' => $kodeRPS ]) }}"><i class="bi bi-pencil-square"></a></i></div>
                            <div class="table-cell"><a href="{{ route('edit_rps.delete_komponen_penilaian', ['id_komponen_penilaian' => $item->id_komponen_penilaian, 'kodeRPS' => $kodeRPS ]) }}"><i class="bi bi-trash-fill"></i></a></div>
                        </div>
                        @endforeach
