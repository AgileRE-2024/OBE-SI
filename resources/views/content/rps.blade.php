    ...
    <div class="content px-4">
        ...
        <table class="table table-bordered" style="text-align: center">
            ...
            <thead style="background-color: lightgray">
                <tr>
                    <th class="align-middle" scope="col" rowspan="3" colspan="1" style="width: 15%"><img
                            src="{{ asset('unair.png') }}" width="75" height="75"></th>
                    <th class="align-middle" scope="col" rowspan="3" colspan="5" style="width: 70%">UNIVERSITAS
                        AIRLANGGA<br>FAKULTAS SAINS DAN TEKNOLOGI<br>PRODI SISTEM INFORMASI</th>
            ...
            <tbody>
                ...
                <tr>
                    <th class="align-middle" scope="col" colspan="7" style="width: 100%">RENCANA PEMBELAJARAN SEMESTER
                    </th>
                </tr>
                <tr>
                ...
                @if ($counterBk == 1)
                    <tr>
                        ...
                        <td class="align-middle" rowspan="1" style="width: 25%">({{ $bk_list->first()->kodeBK }}) <br>
                            {{ $bk_list->first()->namaBK }}</td>
                ...
                @endforeach
                <tr>
                    <th style="text-align: left;" rowspan="1" colspan="3">Capaian Pembelajaran Mata Kuliah (CPMK)
                    </th>
                </tr>
        ...
        <table class="table table-bordered" style="text-align: center">
            <thead style="background-color: lightgray">
                <tr>
                    ...
                    <th class="align-middle" colspan="2" style="width: 20%">Bentuk Pembelajaran Metode Pembelajaran
                        Penugasan Mahasiswa [Estimasi Waktu]</th>
