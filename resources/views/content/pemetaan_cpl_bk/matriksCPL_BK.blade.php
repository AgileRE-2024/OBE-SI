    ...
    <div class="content px-4">
        <div class="card border" style="background-color: white">
            <div class="card-body" style="font-weight:600;">
                ...
                <h5 style="font-weight: 400;"><b><i class="bi bi-quote"></i></b>Pemetaan CPL terhadap BK dilakukan untuk
                    menunjukan BK yang dibutuhkan dalam
                    memenuhi setiap CPL yang telah ditetapkan.<b style="display:inline-block;transform: scaleX(-1)"><i
                    ...
                    <table class="table table-bordered" style="text-align: center">
                        <thead style="background-color: lightgray">
                            <tr>
                                ...
                                <th scope="col" colspan="{{ $cpl_list->count() }}">Capaian Pembelajaran Lulusan (CPL)
                                </th>
                            </tr>
                            <tr>
                            ...
                            @foreach ($empty as $item)
                                <tr>
                                    ...
                                    <th style="background-color: yellow;" scope="row"><span
                                            name="{{ $bk_list->where('kodeBK', '===', $item)->first()['namaBK'] }}">{{ $bk_list->where('kodeBK', '===', $item)->first()['kodeBK'] }}</span>
                                    </th>
                                    <th style="background-color: yellow;" scope="row" class="text-start">
                                        {{ $bk_list->where('kodeBK', '===', $item)->first()['namaBK'] }}</th>
                                    @foreach ($cpl_list as $cpl)
                                        <td style="background-color: yellow;"><input type="checkbox"
                                                ...
                                                value="{{ $bk_list->where('kodeBK', '===', $item)->first()['kodeBK'] }}&{{ $cpl->kodeCPL }}"
                            ...
                            @foreach ($bk_list as $bk)
                                @if (!in_array($bk->kodeBK, $empty))
                                    <tr>
                                        ...
                                        <th scope="row"><span name="{{ $bk->namaBK }}">{{ $bk->kodeBK }}</span>
                                        </th>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="submitButton" class="btn btn-success">Simpan
                                        Perubahan</button>
                                </div>
                            </div>
                        </div>
