                            ...
                            @if (auth()->user()->role == 1 || auth()->user()->role == 3)
                                <td scope="row">
                                    <a class="btn btn-primary"
                                        href="{{ route('kurikulum.data.edit_teknik', $teknik->id_teknik_penilaian) }}">Edit</a>
                                </td>
                                <td scope="row">
                                    <a class="btn btn-danger"
                                        href="{{ route('kurikulum.data.delete_teknik', $teknik->id_teknik_penilaian) }}">Delete</a>
                                </td>
                            @endif
                        </tr>
                    @endforeach
                    ...
                    @foreach ($instrumens as $instrumen)
                        <tr>
                            ...
                            @if (auth()->user()->role == 1 || auth()->user()->role == 3)
                                <td scope="row">
                                    <a class="btn btn-primary"
                                        href="{{ route('kurikulum.data.edit_instrumen', $instrumen->id_instrumen_penilaian) }}">Edit</a>
                                </td>
                                <td scope="row">
                                    <a class="btn btn-danger"
                                        href="{{ route('kurikulum.data.delete_instrumen', $instrumen->id_instrumen_penilaian) }}">Delete</a>
                                </td>
                            @endif
                        </tr>
                    @endforeach
