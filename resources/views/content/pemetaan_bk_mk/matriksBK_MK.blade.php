    ...
    <div class="content px-4">
        <div class="card border" style="background-color: white">
            <div class="card-body" style="font-weight:600;">
                ...
                <h5 style="font-weight: 400;"><b><i class="bi bi-quote"></i></b>Pemetaan BK terhadap MK dilakukan untuk
                    menunjukan turunan dari bahan kajian ke
                    beberapa mata kuliah. Bahan kajian dalam matakuliah akan mempengaruhi keluasan
                    MK yang akan mempengaruhi penentuan SKS.<b style="display:inline-block;transform: scaleX(-1)"><i
                        ...
                        @foreach ($empty as $item)
                            <tr>
                                ...
                                <th style="background-color: yellow;" scope="row"><span
                                        name="{{ $mk_list->where('kodeMK', '===', $item)->first()['namaMK'] }}">{{ $mk_list->where('kodeMK', '===', $item)->first()['kodeMK'] }}</span>
                                </th>
                                <th style="background-color: yellow;" scope="row" class="text-start">
                                    {{ $mk_list->where('kodeMK', '===', $item)->first()['namaMK'] }}</th>
                                @foreach ($bk_list as $bk)
                                    <td style="background-color: yellow;"><input type="checkbox"
                                            ...
                                            style="width:26px;height:26px; @if (auth()->user()->role == 0 || auth()->user()->role == 2) width:26px;height:26px;background-color: blue !important; @endif">
