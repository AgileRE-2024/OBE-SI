    ...
    <div class="content px-4">
        ...
        <div class="card border" style="background-color: white">
            <div class="card-body" style="font-weight:600;">
                ...
                <h5 style="font-weight: 400;"><b><i class="bi bi-quote"></i></b>Standar teknik penilaian setiap mata
                    kuliah<b style="display:inline-block;transform: scaleX(-1)"><i class="bi bi-quote"></i></b></h5>
            </div>
        </div>
        <div class="d-flex justify-content-start pt-2">
            <div>
