...
@section('content')
    <div class="content px-4">
        ...
        <div class="d-flex justify-content-start pt-2">
            ...
            @endif
            <div class="pr-3">
                <a class="btn btn-outline-danger" href="{{ route('export_PDF_pustaka') }}"><i
                        class="bi bi-file-earmark-pdf-fill">
                    </i>Export PDF</a>
            </div>
            <div>
                <a class="btn btn-success" href="{{ route('export_excel_pustaka') }}"><i class="bi bi-file-earmark-excel">
                    </i>Export
                    Excel</a>
            </div>
        </div>
