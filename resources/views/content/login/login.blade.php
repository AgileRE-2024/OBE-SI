...
<center>
    ...
    <div class="col-8 mt-7">
        ...
        @endif
        <div class="card text-white mt-100" style="width: 480px; height:auto; max-height:auto; background-color: #1F2F4D; border-radius: 50px; margin: 70px 0 0 0; padding: 0 50px 0 50px">
            <div class="card-body">
            ...
            <form action="/proseslogin" method="POST" class="card-text" style="text-align: left" autocomplete="on">
                ...
                <div class="la" style="text-align: left; margin:10px 0 0 0;">
                    ...
                    <div class="input-group">
                        <input type="password" name="password" class="form-control" id="password" placeholder="Masukkan kata sandi dengan benar">
                ...
                <center class="mt-3 mb-10">
                    <button name="tombolLogin" type="submit" style="text-align:center; margin: -2px 0 0 0; width:100%; height:50px; border: 2px solid; background: white; border-radius: 10px; font-size:18px; color:#1F2261;">
                        <b>Masuk</b>
                    </button>
