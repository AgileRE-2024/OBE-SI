...
@section('content')
    <div class="content px-4">
        ...
        <div class="d-flex justify-content-start pt-2">
            <div>
                <a class="btn btn-success" href={{ route('edit_rps.add_peran_dosen', $kodeRPS) }} ><i class="bi bi-plus-square">
                    </i>Tambah</a>
            </div>
        </div>
        {{-- <div class="d-flex justify-content-end pt-2">
            <div class="pr-3">
                <a class="btn btn-outline-danger" href="/dosens/exportPdf"><i
...
@endif
        ...
        <td scope="row">
            <a class="btn btn-primary" href='/dashboard/rps/edit/edit_peran_dosen/{{$detail->nip}}/{{ $detail->kodeRPS }}/{{$detail->peranDosen}}'>Edit</a>
        </td>
        <td scope="row">
            <a class="btn btn-danger" href={{ route('edit_rps.delete_peran_dosen', [$detail->nip, $detail->kodeRPS,$detail->peranDosen]) }}>Delete</a>
        </td>
    </tr>
@endforeach
