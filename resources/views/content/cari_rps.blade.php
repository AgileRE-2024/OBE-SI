                    ...
                    <div class="content px-4">
                                    ...
                                    @if (auth()->user()->role == 0)
                                        <div class="pl-2">
                                            <a id="edit" class="btn btn-warning"
                                                href="{{ route('edit_rps.teknik_penilaian', ['kodeRPS' => $rps->kodeRPS]) }}"
                                                style="float: left;"><i class="bi bi-pencil-square"></i> Edit RPS</a>
                                        </div>
                                    @endif
                                @endif
                            </div>
                            ...
                            <div style="display: flex;">
                                <div style="margin-right: 10px;">
                                    <a id="pdf" class="btn btn-outline-danger"
                                        href="{{ route('export_rps', ['type' => 'pdf', 'kodeRPS' => $kodeRPS]) }}"><i
                        ...
                        <table class="table table-bordered" style="text-align: center">
                            ...
                            <thead style="background-color: lightgray">
                                <tr>
                                    <th class="align-middle" scope="col" rowspan="3" colspan="1"
                                        style="width: 15%"><img src="{{ asset('unair.png') }}" width="75"
                                            height="75"></th>
                                    <th class="align-middle" scope="col" rowspan="3" colspan="5"
                                        style="width: 70%">UNIVERSITAS AIRLANGGA<br>FAKULTAS SAINS DAN TEKNOLOGI<br>PRODI
                                        SISTEM INFORMASI</th>
                                    <th class="align-middle" scope="col" rowspan="3" colspan="1"
                                        style="width: 15%">{{ $kodeRPS }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- <h1>{{ $mk->with('Bahan_Kajian')->first()->namaBK }}</h1> --}}
                                <tr>
                                    <th class="align-middle" scope="col" colspan="7" style="width: 100%">RENCANA
                                        PEMBELAJARAN SEMESTER</th>
                                </tr>
                                <tr>
                                    <th class="align-middle" rowspan="1" colspan="2" style="width: 25%">MATA KULIAH
                                        (MK)</th>
                                    <th class="align-middle" rowspan="1" style="width: 10%">KODE</th>
                                    <th class="align-middle" rowspan="1" style="width: 25%">Bahan Kajian (BK)</th>
                                    <th class="align-middle" rowspan="1" colspan="1" style="width: 15%">BOBOT (sks)
                                    </th>
                                ...
                                @if ($counterBk == 1)
                                    <tr>
                                        <td class="align-middle" rowspan={{ $counterBk }} colspan="2"
                                            style="width: 25%">{{ $mk->namaMK }}
                                            @if ($mk->jenisMK == 1)
                                                <span>(Teori)</span>
                                            @endif
                                            @if ($mk->jenisMK == 2)
                                ...
                                @else
                                    @for ($i = 0; $i < $counterBk; $i++)
                                        @if ($i == 0)
                                            <tr>
                                                <td class="align-middle" rowspan={{ $counterBk }} colspan="2"
                                                    style="width: 25%">{{ $mk->namaMK }}</td>
                                                <td class="align-middle" rowspan={{ $counterBk }} style="width: 10%">
                                                    {{ $mk->kodeMK }}</td>
                                                <td class="align-middle" rowspan="1" style="width: 25%">
                                                    ({{ $bk_list->first()->kodeBK }}) <br> {{ $bk_list->first()->namaBK }}
                                                </td>
                                                <td class="align-middle" rowspan={{ $counterBk }} style="width: 15%">
                                                    {{ $mk->sks }}</td>
                                                <td class="align-middle" rowspan={{ $counterBk }} style="width: 10%">
                                        ...
                                        @else
                                            <tr>
                                                <td class="align-middle" rowspan="1" style="width: 10%">
                                                    ({{ $bk_list->get($i)->kodeBK }}) <br> {{ $bk_list->get($i)->namaBK }}
                                                </td>
                                            </tr>
                                        @endif
                                    @endfor
                                ...
                                @endphp
                                <tr>
                                    <th style="text-align: left;" colspan="2" rowspan="2" style="width: 25%">
                                        Pengesahan</th>
                                ...
                                @php
                                    ...
                                    $list_dosen_pengampu = $detail_peran_dosen_list
                                        ->where('kodeRPS', $rps->kodeRPS)
                                        ->where('peranDosen', 'Dosen Pengampu')
                                        ->pluck('nip');
                                    ...
                                    $rowspanCP = 6;
                                    $rowspanCP =
                                        $rowspanCP + $list_cpl->count() + $list_cpmk->count() + $list_subcpmk->count();
                                @endphp
                                <tr>
                                    <th style="text-align: left;" rowspan={{ $rowspanCP }} colspan="1">Capaian
                                        Pembelajaran</th>
                                </tr>
                                <tr>
                                    <th style="text-align: left;" rowspan="1" colspan="3">CPL-PRODI yang dibebankan
                                        pada MK</th>
                                </tr>
                                {{-- Looping CPL --}}
                                @foreach ($list_cpl as $cpl)
                                    <tr>
                                        <td style="text-align: left;" rowspan="1" colspan="1">
                                            {{ $cpl['kodeCPL'] }}</td>
                                        <td style="text-align: left;" rowspan="1" colspan="6">
                                            {{ $cpl['deskripsiCPL'] }}</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    <th style="text-align: left;" rowspan="1" colspan="3">Capaian Pembelajaran Mata
                                        Kuliah (CPMK)</th>
                                </tr>
                                @foreach ($list_cpmk as $cpmk)
                                    <tr>
                                        <td style="text-align: left;" rowspan="1" colspan="1">
                                            {{ $cpmk['kodeCPMK'] }}</td>
                                        <td style="text-align: left;" rowspan="1" colspan="6">
                                            {{ $cpmk['deskripsiCPMK'] }}</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    <th style="text-align: left;" rowspan="1" colspan="3">Kemampuan akhir tiap
                                        tahapan belajar (Sub-CPMK)</th>
                                </tr>
                                @foreach ($list_subcpmk as $subcpmk)
                                    <tr>
                                        <td style="text-align: left;" rowspan="1" colspan="1">
                                            {{ $subcpmk->kodeSubCPMK }}</td>
                                        <td style="text-align: left;" rowspan="1" colspan="6">
                                            {{ $subcpmk->deskripsiSubCPMK }}</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    <th style="text-align: left;" rowspan="1" colspan="3">Korelasi CPMK terhadap
                                        Sub-CPMK</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;" rowspan="1" colspan="7">{{ $mk->deskripsiMK }}
                                    </td>
                                </tr>
                                {{-- <tr>
                        ...
                        <th style="text-align: left;" rowspan="1" colspan="7">...</th>
                                ...
                                <tr>
                                    <th style="text-align: left;" rowspan="1" colspan="1">Mata Kuliah Prasyarat
                                    </th>
                                    <td style="text-align: left;" rowspan="1" colspan="7">
                        ...
                        <table class="table table-bordered" style="text-align: center">
                            <thead style="background-color: lightgray">
                                <tr>
                                    ...
                                    <th class="align-middle" rowspan="2" style="width: 15%">Kemampuan akhir tiap
                                        tahapan belajar (Sub-CPMK)</th>
                                    ...
                                    <th class="align-middle" colspan="2" style="width: 20%">Bentuk Pembelajaran Metode
                                        Pembelajaran Penugasan Mahasiswa [Estimasi Waktu]</th>
                                    <th class="align-middle" rowspan="2" style="width: 10%">Materi
                                        Pembelajaran[Pustaka]</th>
        ...
        <div class="content px-4">
            <div class="content px-4">
                ...
                <table class="table table-bordered" style="text-align: center">
                    ...
                    <thead style="background-color: lightgray">
                        <tr>
                            <th class="align-middle" scope="col" rowspan="3" colspan="1" style="width: 15%">
                                <img src="{{ asset('unair.png') }}" width="75" height="75"></th>
                            <th class="align-middle" scope="col" rowspan="3" colspan="5" style="width: 70%">
                                UNIVERSITAS AIRLANGGA<br>FAKULTAS SAINS DAN TEKNOLOGI<br>PRODI SISTEM INFORMASI</th>
                            <th class="align-middle" scope="col" rowspan="3" colspan="1" style="width: 15%">
                                {{ $kodeRPS }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <th class="align-middle" rowspan="1" colspan="2" style="width: 25%">MATA KULIAH (MK)
                            </th>
                            <th class="align-middle" rowspan="1" style="width: 10%">KODE</th>
                            <th class="align-middle" rowspan="1" style="width: 25%">Bahan Kajian (BK)</th>
                        ...
                        @endphp
                        <tr>
                            <th style="text-align: left;" colspan="2" rowspan="2" style="width: 25%">Pengesahan
                            </th>
                            <th style="text-align: left;" colspan="2">Dosen Pengembang RPS</th>
                            <th style="text-align: left;" colspan="1">Koordinator BK</th>
                            <th style="text-align: left;" colspan="3">Ka Prodi</th>
                        ...
                        @endphp
                        <tr>
                            <th style="text-align: left;" rowspan={{ $rowspanCP }} colspan="1">Capaian Pembelajaran
                            </th>
                        </tr>
                        <tr>
                        ...
                        @foreach ($list_cpl as $cpl)
                            <tr>
                                ...
                                <td style="text-align: left;" rowspan="1" colspan="6">{{ $cpl['deskripsiCPL'] }}
                                </td>
                            </tr>
                        @endforeach
                        <tr>
                        ...
                        @foreach ($list_cpmk as $cpmk)
                            <tr>
                                <td style="text-align: left;" rowspan="1" colspan="1">{{ $cpmk['kodeCPMK'] }}
                                </td>
                                <td style="text-align: left;" rowspan="1" colspan="6">
                                    {{ $cpmk['deskripsiCPMK'] }}</td>
                            </tr>
                        @endforeach
                        <tr>
                            <th style="text-align: left;" rowspan="1" colspan="3">Kemampuan akhir tiap tahapan
                                belajar (Sub-CPMK)</th>
                        </tr>
                        @foreach ($list_subcpmk as $subcpmk)
                            <tr>
                                <td style="text-align: left;" rowspan="1" colspan="1">{{ $subcpmk->kodeSubCPMK }}
                                </td>
                                <td style="text-align: left;" rowspan="1" colspan="6">
                                    {{ $subcpmk->deskripsiSubCPMK }}</td>
                            </tr>
                        @endforeach
                        <tr>
                            <th style="text-align: left;" rowspan="1" colspan="3">Korelasi CPMK terhadap Sub-CPMK
                            </th>
                        </tr>
                        <tr>
                            <td style="text-align: left;" scope="col" rowspan="1" colspan="7">
                ...
                <table class="table table-bordered" style="text-align: center">
                    <thead style="background-color: lightgray">
                        <tr>
                            <th class="align-middle" rowspan="2" style="width: 5%">Minggu Ke-</th>
                            <th class="align-middle" rowspan="2" style="width: 15%">Kemampuan akhir tiap tahapan
                                belajar (Sub-CPMK)</th>
                            <th class="align-middle" rowspan="2" style="width: 10%">Indikator</th>
                            <th class="align-middle" rowspan="2" style="width: 10%">Kriteria & Teknik</th>
                            <th class="align-middle" colspan="2" style="width: 20%">Bentuk Pembelajaran Metode
