            ...
            <table class="table table-bordered" style="text-align: center">
                <thead style="background-color: lightgray">
                    <tr>
                        ...
                        <th class="align-middle" scope="col" rowspan="2" style="width: 15%">Bentuk dan Metode
                            Pembelajaran
                        </th>
                        ...
                        <th class="align-middle" scope="col" rowspan="2" style="width: 15%">Pengalaman belajar
                            mahasiswa
                        </th>
                        ...
                        @if (auth()->user()->role == 0 || auth()->user()->role == 3)
                            <th id="edit" class="align-middle" scope="col" rowspan="2" style="width: 15%">Edit
                            </th>
                        @endif
                    </tr>
                </thead>
                            ...
                            @if (auth()->user()->role == 0 || auth()->user()->role == 3)
                                <td scope="row">
                                    <a id="edit" class="btn btn-primary"
                                        href="{{ route('edit_rps.edit_minggu_rps', ['kodeMingguRPS' => $minggurps->kodeMingguRPS]) }}">Edit</a>
                                </td>
                            @endif
                        </tr>
                        @if ($key == 6)
