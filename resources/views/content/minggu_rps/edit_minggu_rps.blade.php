                        ...
                        <form method="post"
                            ...
                            <div class="form-group">
                                ...
                                @error('waktuPembelajaran')
                                    <h6 style="color: #BF2C45">{{ $message }}</h6>
                                @enderror
                                <textarea rows="3" name="waktuPembelajaran" class="form-control" placeholder="Waktu Pembelajaran"
                            ...
                            <div class="form-group">
                                ...
                                @error('pengalaman_belajar')
                                    <h6 style="color: #BF2C45">{{ $message }}</h6>
                                @enderror
                                <textarea rows="3" name="pengalaman_belajar" class="form-control" placeholder="Pengalaman Belajar"
                            ...
                            <div class="form-group" id="div_bobot"
                                ...
                                <input type="number" name="bobot_nilai" class="form-control" placeholder="Bobot Nilai"
                                    value="{{ old('bobot_nilai') ? old('bobot_nilai') : $minggu_rps->bobot_nilai }}"
                                    min="0" max="100">
                            </div>
                            ...
                            <div id="dynamicAddRemove">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <button type="button" name="add" id="dynamic-ar"
                                        class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i> Tambah</button>
                                </div>
                                <div class="form-group">
                                    @error('judul_pustaka')
                                        <h6 style="color: #BF2C45">{{ $message }}</h6>
                                    ...
                                    <select name="pustaka[0][judul]" id="judul_pustaka" class="form-select mb-1">
                                        ...
                                        @foreach ($pustaka as $item)
                                            <option value="{{ $item->id_pustaka }}"
                                                @if ($firstPustakaId && $item->id_pustaka == $firstPustakaId) selected @endif>{{ $item->judul }}
                                            </option>
                                        @endforeach
                                    </select>
