...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body" style="width: auto">
            <div class="col-sm-8">
                <form method="post"
                    action="{{ route('kurikulum.data.update_kriteria', $kriteria->id_kriteria_penilaians) }}">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kriteria_penilaians" class="form-control"
                            ...
                            value="{{ old('nama_kriteria_penilaians') ? old('nama_kriteria_penilaians') : $kriteria->nama_kriteria_penilaians }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deskripsi_kriteria_penilaians" class="form-control"
                            ...
                            value="{{ old('deskripsi_kriteria_penilaians') ? old('deskripsi_kriteria_penilaians') : $kriteria->deskripsi_kriteria_penilaians }}">
                    </div>
