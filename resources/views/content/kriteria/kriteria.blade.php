...
<div class="content px-4">
    <div class="card border" style="background-color: white">
        <div class="card-body" style="font-weight:600;">
            ...
            <h5 style="font-weight: 400;"><b><i class="bi bi-quote"></i></b>Daftar Opsi Kriteria Penilaian<b style="display:inline-block;transform: scaleX(-1)"><i class="bi bi-quote"></i></b></h5>
        </div>
    </div>
        ...
        <table class="table table-bordered" style="text-align: center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if (auth()->user()->role == 1 || auth()->user()->role == 3)
                    <td scope="row">
                        <a class="btn btn-primary" href="{{ route('kurikulum.data.edit_kriteria', $kriteria->id_kriteria_penilaians) }}">Edit</a>
                    </td>
                    <td scope="row">
                        <a class="btn btn-danger" href="{{ route('kurikulum.data.delete_kriteria', $kriteria->id_kriteria_penilaians) }}">Delete</a>
                    </td>
                    @endif
                </tr>
                @endforeach
