    ...
    <div class="px-4">
        <div class="card border" style="background-color: white">
            <div class="card-body" style="font-weight:600;">
                ...
                <h5 style="font-weight: 400;"><b><i class="bi bi-quote"></i></b>Susunan Mata Kuliah berisi pemetaan mata
                    kuliah berdasarkan semesternya, disertai oleh data-data yang mengikuti. User dapat memilih dan melakukan
                    edit pada data setiap mata kuliah berupa SKS, Semester, dan Keterangan.<b
            ...
            <table class="table table-bordered" style="text-align: center">
                ...
                <tbody>
                    @foreach ($MK as $p)
                                    ...
                                    @if (strpos($p->semester, strval($i)) !== false)
                                        <div class="d-flex justify-content-center">
                                            <div class="form-check">
                                                <input style="width:26px;height:26px;" class="form-check-input"
                                                    type="checkbox" checked disabled
                                                    style="background-color: blue !important; border-color: blue !important;">
                                            </div>
                                        </div>
                                    @else
                                        <div class="d-flex justify-content-center">
                        ...
                        <!-- Edit Modal -->
                        <div class="modal fade" id="edit{{ $p->kodeMK }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('kurikulum.pemetaan.update_susunan_mk', $p->kodeMK) }}"
                                        class="myForm" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="kodeMK" value="{{ $p->kodeMK }}">
                                        <div class="modal-body">
                                            <p class="text-center">{{ $p->kodeMK }} {{ ':' }}
                                                {{ $p->namaMK }}</p>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="kategoriMK" name="kategoriMK">
                                                    <option value="1"
                                                        {{ old('kategoriMK', $p->kategoriMK) == '1' ? 'selected' : '' }}>
                                                        Wajib</option>
                                                    <option value="2"
                                                        {{ old('kategoriMK', $p->kategoriMK) == '2' ? 'selected' : '' }}>
                                                        Pilihan</option>
                                                    <option value="3"
                                                        {{ old('kategoriMK', $p->kategoriMK) == '3' ? 'selected' : '' }}>
                                                        MKWK</option>
                                                </select>
                                            </div>
                                        </div>
