                    ...
                    <ul class="nav nav-treeview pl-3">
                        ...
                        <li class="nav-item @if (Request::is('*pemetaan*')) menu-open @endif">
                            ...
                            <ul class="nav nav-treeview pl-3">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('kurikulum.pemetaan.admin.matriks') }}" class="nav-link"
                                        @if (URL::current() === route('kurikulum.pemetaan.admin.matriks')) style="background-color: #989898; color: black;" @endif>
                                        <p style="font-size: 14px">
                                            <i class="bi bi-caret-right-fill"></i>
