...
//READ
Route::get('/dosens', [DosenController::class, 'index'])->name('dosen.index');

//UPDATE
Route::get('/dosens/{nip}', [DosenController::class, 'show'])->name('dosen.show');
Route::get('/dosens/{nip}/edit', [DosenController::class, 'edit'])->name('dosen.edit');
Route::put('/dosens/{nip}', [DosenController::class, 'update'])->name('dosen.update');
Route::get('/get-nama-dosen/{nip}', [DosenController::class, 'getNamaDosen'])->name('dosen.getNamaDosen');
