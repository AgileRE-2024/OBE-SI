...
class PustakaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Pustaka::create([
            ...
            "tahun" => 2003,
            "judul" =>
                "Business Process Management: Integration to Web-Enabled Environment",
            "penerbit" => "Prentice Hall",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 1984,
            "judul" =>
                "Multivariate Descriptive Statistical Analysis, Correspondence Analysis and Related Techiniques for large matrices",
            "penerbit" => "Wiley",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 2007,
            "judul" =>
                "A Best evidence systematic review of interproffesional education: BEME Guide no 9 Med Teach",
            "penerbit" => "",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 2010,
            "judul" =>
                "Framework for action on interprofesional Education & Collaborative Practice",
            "penerbit" => "",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 2015,
            "judul" =>
                "Interprofessional collaboration in health care Lesson to be leared from competitive sport",
            "penerbit" => "",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "Wangsington, DC: Interproffessiomal Eduvation Collaborative",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => null,
            "judul" =>
                "CISCO Networking Academy Program: Routing Protocols and Concepts, CCNAExploration2, ver 4",
            "penerbit" => "",
        ]);
        Pustaka::create([
            "nama_penulis" => "",
            "tahun" => null,
            "judul" =>
                "CISCO Networking Academy Program: Network Fundamentals, CCNAExploration 1, ver 4,",
            "penerbit" => "",
        ]);
        //APS Teori
        Pustaka::create([
        ...
        Pustaka::create([
            ...
            "tahun" => 2018,
            "judul" =>
                "Requirements Engineering for Software and Systems 3rd Ed",
            "penerbit" => "CRC Press",
        ]);
        ...
        Pustaka::create([
            "judul" =>
                "Dokumen Ajaran sosial Gereja lainnya dari sumber Gereja Katolik.",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 2009,
            "judul" =>
                "Negara Paripurna, Aktualitas dan Historisitas Pancasila",
        ...
        Pustaka::create([
            ...
            "tahun" => 2020,
            "judul" =>
                "2020. Automate the Boring Stuff with Python, Second Edition: Practical Programming for Total Beginners.",
        ...
        Pustaka::create([
            ...
            "tahun" => 1993,
            "judul" =>
                "Understanding and Using English Grammar : Edisi Bahasa Inggris - Indonesia",
        ...
        Pustaka::create([
            ...
            "tahun" => 2016,
            "judul" =>
                "Introduction to Cybercrime: Computer Crimes, Laws, and Policing in the 21st Century: Computer Crimes, Laws, and Policing in the 21st Century.",
            "penerbit" => "ABC-CLIO",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 2017,
            "judul" =>
                "Sukses Mengelola Layanan Teknologi Informasi dan Kiat Lulus Ujian Sertifikasi ITIL Foundation",
            "penerbit" => "AISINDO",
        ]);
        ...
        Pustaka::create([
            "nama_penulis" =>
                "Gonzalez R. C, Richard E.Woods, Steven L.Eddins.",
            "tahun" => 2004,
        ...
        Pustaka::create([
            ...
            "tahun" => 2011,
            "judul" =>
                "(2011). Software testing and quality assurance: theory and practice.",
            "penerbit" => "John Wiley & Sons, Inc.",
        ]);

        Pustaka::create([
            "nama_penulis" =>
                "Hambling, B., Morgan, P., Samaroo, A., Thompson, G., & Williams, P.",
            "tahun" => 2015,
        ...
        Pustaka::create([
            ...
            "tahun" => 2019,
            "judul" =>
                "Interaction design: beyond human-computer interaction 5th ed.",
            "penerbit" => "Wiley",
        ]);
        ...
        Pustaka::create([
            ...
            "tahun" => 2006,
            "judul" =>
                "Mengasah Menulis Keterampilan Ilmiah di Perguruan Tinggi.",
            "penerbit" => "Jakarta: Graha Ilmu",
        ]);
        Pustaka::create([
            "nama_penulis" =>
                "Tim MPK Bahasa Indonesia TPB Universitas Airlangga.",
            "tahun" => 2007,
            "judul" =>
                "Buku Ajar Matakuliah Pengembangan Kepribadian (MPK) Bahasa Indonesia untuk Perguruan Tinggi.",
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "Family Practice, 25(2), 127-131. doi: https://doi.org/10.1093/fampra/cmn003",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "International Journal of Qualitative Methods, 8(2), 35-52. doi: https://doi.org/10.1177/160940690900800206",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "Purdue University Library. Diakses dari https://www.lib.purdue.edu/sites/default/files/libraries/engr/Tutorials/Newest%20Scientific%20Paper.pdf",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "Journal of thoracic disease, 9(10), 4125. https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5723800/",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "The Stanford Encyclopedia of Philosophy. Diakses dari https://plato.stanford.edu/entries/science-big-data/",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "The Conversation. Diakses dari https://theconversation.com/dont-just-google-it-3-ways-students-can-get-the-most-from-searching-online-116519",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "Science Magazine. Diakses di https://www.sciencemag.org/careers/2016/03/how-seriously-read-scientific-paper",
        ]);
        ...
        Pustaka::create([
            ...
            "penerbit" =>
                "dalam W. Yustisia, M. A. Hakim, & R. Ardi (Ed.), Psikologi politik (pp. 33-74). Jakarta: Penerbit Buku Kompas. http://repository.unair.ac.id/104471/",
        ]);
        ...
        Pustaka::create([
            "nama_penulis" =>
                "Adib, Mohammad, Listiyono Santoso, dan Ajar Triharso",
            "tahun" => 2013,
            "judul" =>
                "Pendidikan Pancasila dan Kewarganegaraan: Sebuah Pengantar Membangun Karakter Bangsa",
        ...
        Pustaka::create([
            ...
            "tahun" => 2016,
            "judul" =>
                "Bangunlah Jiwanya, Bangunlah Bangsanya: Penguatan Karakter Bangsa dalam Pembelajaran Pendidikan Kewarganegaraan",
            "penerbit" =>
                "Surabaya: Saga dan Direktorat Pendidikan Universitas Airalanga. (Cet. Kedua)",
        ]);

        Pustaka::create([
            "nama_penulis" =>
                "Kemenristek Dikti, Ditjen Pembelajaran dan Kemahasiswaan",
            "tahun" => 2016,
            "judul" =>
                "Pendidikan Kewarganegaraan untuk Perguruan Tinggi. (Cet. I)",
        ...
        Pustaka::create([
            "nama_penulis" =>
                "Daren S. Starnes, Josh Tabor, Daniel S. Yates, David S. Moore",
            "tahun" => 2015,
