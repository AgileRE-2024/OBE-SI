...
class MataKuliahSeeder extends Seeder
{
    ...
    public function run()
    {
        $matkul = [
            ...
            ['MAL103', 'Matriks dan Transformasi Linier', 2, 2, 1, 1, null, null, '-'],
            ...
            ['SIC201', 'Pembelajaran Mesin', 2, 4, 1, 1, 'MAL103', 'Mata Kuliah MAS234', '-'],
            ['SIC202', 'Pembelajaran Mesin (praktikum)', 1, 4, 2, 1, 'MAL103', 'Mata Kuliah MAS234', '-'],
