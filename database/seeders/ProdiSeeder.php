...
class ProdiSeeder extends Seeder
{
    ...
    public function run()
    {
        Prodi::create([
            ...
            "gelarLulusan" => "S.Kom",
            "visi" =>
                "Menjadi program studi unggul dan terkemuka dalam bidang Sistem Informasi di tingkat nasional dan internasional, serta berperan serta dalam pengembangan masyarakat ilmiah, yang beradab, dan bermoral agama.",
