...
class CPMKSeeder extends Seeder
{
    ...
    public function run()
    {
        CPMK::create([
            "kodeCPMK" => "CPMK001",
            "deskripsiCPMK" =>
                "Setelah mengikuti perkuliahan, mahasiswa dapat : a). mengimplementasikan berbagai macam cara memperkuat Iman dan Takwa, b). mengembangkan akhlak mulia serta c). menjadikan ajaran Kristen Protestan sebagai landasan berfikir & berperilaku dalam pengembangan profesi.",
            "kodeCPL" => "LO-01",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK002",
            "deskripsiCPMK" =>
                "Setelah mengikuti perkuliahan, mahasiswa dapat : a). mengimplementasikan berbagai macam cara memperkuat Iman dan Takwa, b). mengembangkan akhlak mulia serta c). menjadikan ajaran Katolik sebagai landasan berfikir & berperilaku dalam pengembangan profesi.",
            "kodeCPL" => "LO-01",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK003",
            "deskripsiCPMK" =>
                "Setelah mengikuti perkuliahan, mahasiswa dapat : a). mengimplementasikan berbagai macam cara memperkuat Iman dan Takwa, b). mengembangkan akhlak mulia serta c). menjadikan ajaran Islam sebagai landasan berfikir & berperilaku dalam pengembangan profesi.",
            "kodeCPL" => "LO-01",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK004",
            "deskripsiCPMK" =>
                "Setelah mengikuti perkuliahan, mahasiswa dapat : a). mengimplementasikan berbagai macam cara memperkuat Iman dan Takwa, b). mengembangkan akhlak mulia serta c). menjadikan ajaran Hindu sebagai landasan berfikir & berperilaku dalam pengembangan profesi.",
            "kodeCPL" => "LO-01",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK005",
            "deskripsiCPMK" =>
                "Setelah mengikuti perkuliahan, mahasiswa dapat : a). mengimplementasikan berbagai macam cara memperkuat Iman dan Takwa, b). mengembangkan akhlak mulia serta c). menjadikan ajaran Budha sebagai landasan berfikir & berperilaku dalam pengembangan profesi.",
            "kodeCPL" => "LO-01",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK006",
            "deskripsiCPMK" =>
                "Setelah mengikuti perkuliahan, mahasiswa dapat : a). mengimplementasikan berbagai macam cara memperkuat Iman dan Takwa, b). mengembangkan akhlak mulia serta c). menjadikan ajaran Konghucu sebagai landasan berfikir & berperilaku dalam pengembangan profesi.",
            "kodeCPL" => "LO-01",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK009",
            "deskripsiCPMK" =>
                "Mahasiswa dapat menguraikan komposisi materi, reaksi dasar dan perhitungan, serta senyawa karbon",
            "kodeCPL" => "LO-02",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK011",
            "deskripsiCPMK" =>
                "Setelah mengikuti mata kuliah Kalkulus, mahasiswa diharapkan dapat menggunakan konsep-konsep kalkulus, khususnya dalam ilmu kehayatan.",
            "kodeCPL" => "LO-12",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK013",
            "deskripsiCPMK" =>
                "Mahasiswa mampu menggunakan data dan referensi ilmiah untuk mengambil keputusan dan mempersuasi",
            "kodeCPL" => "LO-02",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK014",
            "deskripsiCPMK" =>
                "Mahasiswa mampu menjelaskan konsep teoritis bidang pengetahuan Sistem Informasi secara umum.",
            "kodeCPL" => "LO-03",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK015",
            "deskripsiCPMK" =>
                "Mahasiswa mampu menyelesaikan persoalan-persoalan fisis yang berkaitan dengan Mekanika Newton, Gelombang serta Termodinamika.",
            "kodeCPL" => "LO-02",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK017",
            "deskripsiCPMK" =>
                "Mahasiswa mampu membuat algoritma dan mengimplementasikannya pada bahasa pemprograman (K3).",
            "kodeCPL" => "LO-13",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK018",
            "deskripsiCPMK" =>
                "Mahasiswa mampu membuat algoritma dan mengimplementasikannya pada bahasa pemprograman",
            "kodeCPL" => "LO-13",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK021",
            "deskripsiCPMK" =>
                "Mahasiswa mampu meringkas dan menyajikan informasi numerik sehingga menjadi jelas dan berguna (K2).",
            "kodeCPL" => "LO-12",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK023",
            "deskripsiCPMK" =>
                "Mahasiswa diharapkan dapat melakukan pemodelan dan perbaikan proses bisnis (K3).",
            "kodeCPL" => "LO-03",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK024",
            "deskripsiCPMK" =>
                "Mahasiswa diharapkan dapat melakukan pemodelan dan perbaikan proses bisnis dengan menggunakan tools yang sesuai (K3).",
            "kodeCPL" => "LO-03",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK029",
            "deskripsiCPMK" =>
                "Mahasiswa mampu mengambil kesimpulan dari data sampel (K2).",
            "kodeCPL" => "LO-12",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK031",
            "deskripsiCPMK" =>
                "Setelah mengikuti mata kuliah ini mahasiswa diharapkan dapat menyelesaikan permasalahan praktis dalam matematika diskrit.",
            "kodeCPL" => "LO-12",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK033",
            "deskripsiCPMK" =>
                "Setelah mengikuti Mata Ajar ini, mahasiswa diharapkan dapat menentukan algoritma pembelajaran mesin pada kasus tertentu.",
            "kodeCPL" => "LO-10",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK038",
            "deskripsiCPMK" =>
                "Setelah mengikuti mata kuliah ini, mahasiswa diharapkan mampu mengembangkan aplikasi berbasis mobile (K3)",
            "kodeCPL" => "LO-05",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK039",
            "deskripsiCPMK" =>
                "Setelah mengikuti mata kuliah ini, Mahasiswa dapat menerapkan konsep, teori dan aturan-aturan yang berlaku dalam pemrograman web untuk membangun web sederhana untuk dapat menunjang pengembangan teknologi informasi (K3).",
            "kodeCPL" => "LO-05",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK045",
            "deskripsiCPMK" =>
                "Setelah mengikuti mata kuliah ini, mahasiswa diharapkan dapat merancang desain interaksi dengan menggunakan tools (K3).",
            "kodeCPL" => "LO-05",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK063",
            "deskripsiCPMK" =>
                "Mahasiswa diharapkan dapat menggunakan kerangka kerja/standar tertentu untuk melakukan audit sistem informasi (K3).",
            "kodeCPL" => "LO-07",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK066",
            "deskripsiCPMK" =>
                "Mahasiswa diharapkan dapat melakukan pengelolaan risiko teknologi informasi di organisasi berdasarkan kasus tertentu (K4)",
            "kodeCPL" => "LO-07",
        ]);
        ...
        CPMK::create([
            "kodeCPMK" => "CPMK067",
            "deskripsiCPMK" =>
                "Setelah mengikuti mata kuliah ini, mahasiswa mampu merancan desain interaksi yang tepat untuk sistem E-Health (K3)",
            "kodeCPL" => "LO-05",
        ]);
        ...
        //     "kodeCPMK" => "CPMK012",
        //     "deskripsiCPMK" =>
        //         "Mampu menganalisis proses dan sistem organisasi",
        //     "kodeCPL" => "CPL-02",
        // ]);
        ...
        //     "kodeCPMK" => "CPMK013",
        //     "deskripsiCPMK" =>
        //         "Mampu menilai proses dan sistem pengelolaan data pada organisas",
        //     "kodeCPL" => "CPL-01",
        // ]);
        ...
        //     "kodeCPMK" => "CPMK032",
        //     "deskripsiCPMK" =>
        //         "Mampu menggunakan berbagai alat pengembangan sistem",
        //     "kodeCPL" => "CPL-03",
        // ]);
        ...
        //     "kodeCPMK" => "CPMK061",
        //     "deskripsiCPMK" =>
        //         "Mampu merencanakan sistem informasi organisasi untuk mencapai tujuan dan sasaran organisasi jangka panjang",
        //     "kodeCPL" => "CPL-06",
        // ]);
        ...
        //     "kodeCPMK" => "CPMK062",
        //     "deskripsiCPMK" =>
        //         "Mampu menerapkan sistem informasi untuk mencapai tujuan dan sasaran organisasi jangka pendek",
        //     "kodeCPL" => "CPL-06",
        // ]);
        ...
        //     "kodeCPMK" => "CPMK063",
        //     "deskripsiCPMK" =>
        //         "Mampu memelihara sistem informasi organisasi untuk mencapai tujuan organisasi jangka pendek.",
        //     "kodeCPL" => "CPL-06",
        // ]);
        ...
        //     "kodeCPMK" => "CPMK064",
        //     "deskripsiCPMK" =>
        //         "Mampu meningkatkan layanan sistem informasi yang strategis secara jangka pendek.",
        //     "kodeCPL" => "CPL-06",
        // ]);
