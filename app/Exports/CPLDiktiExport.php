...
class CPLDiktiExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    /**
    ...
    {
        return CPL_SN_Dikti::all('kodeCPLSN', 'deskripsiSN', 'sumberSN', 'kategoriSN', 'jenisSN');
    }

    public function headings(): array
    {
        return [
            'Kode CPL SN', 'Sumber CPL SN', 'Kategori CPL SN', 'Jenis CPL SN', 'Deskripsi CPL SN'
        ];
    }
