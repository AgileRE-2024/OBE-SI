...
class PemetaanCPLBKExport implements FromCollection, WithHeadings, WithColumnWidths, WithStyles
{
    protected $bk;
    protected $cpl_prodi;
    ...
    public function collection(): Collection
    {
        ...
        foreach ($this->bk as $bk) {
            ...
            foreach ($this->cpl_prodi as $cpl) {
                if ($this->pemetaan_cpl_bk->where('kodeCPL', $cpl->kodeCPL)->where('kodeBK', $bk->kodeBK)->count()) {
