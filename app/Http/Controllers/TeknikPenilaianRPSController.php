...
class TeknikPenilaianRPSController extends Controller
{
    public function index()
    {
        ...
        return view("content.teknik_penilaian_rps.index", [
    ...
    {
        return view("content.teknik_penilaian_rps.add_teknik_penilaian_rps", [
    ...
    {
        $teknik = Teknik_penilaian_RPS::where(
            "id_teknik_penilaian",
            $id_teknik
        )->first();

        return view("content.teknik_penilaian_rps.edit_teknik_penilaian_rps", [
            "title" => "Edit Teknik Penilaian",
            "teknik" => $teknik,
        ]);
    }
    ...
    public function update($teknik, Request $request)
    {
        ...
        return redirect()
            ->route("kurikulum.data.teknik_penilaian")
            ->with("success", "Teknik penilaian berhasil diubah");
    }
    ...
    public function delete($teknik)
    {
        ...
        return redirect()
            ->route("kurikulum.data.teknik_penilaian")
            ->with("success", "Teknik penilaian berhasil dihapus");
    }
}
