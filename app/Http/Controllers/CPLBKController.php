...
class CPLBKController extends Controller
{
    ...
    $judul = "Pemetaan Capaian Pembelajaran Lulusan (CPL) & Bahan Kadjian (BK)";
    $list_cpl = CPL_Prodi::all();
    $list_bk = Bahan_Kajian::all();
    $detail_cpl_bk = Detail_CPLProdi_BK::all(); 

    return Excel::download(new PemetaanCPLBKExport($list_bk, $list_cpl, $detail_cpl_bk), 'Laporan Pemetaan CPLBK.xlsx');
    }
    ...
    public function viewExcel(){
        ...
        return view('content.pemetaan_cpl_mk.exportpdf_cplmk', compact('judul', 'list_cpl','list_bk','detail_cpl_bk'));
    }    
