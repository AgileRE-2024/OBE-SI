...
class MataKuliahController extends Controller
{
    ...
    public function addMataKuliah()
    {
        ...
        return view('content.mata_kuliah.add_mata_kuliah', ['title' => 'Tambah Mata Kuliah', 'mks' => $mks, 'prodiList' => $prodiList,]);
    }
    ...
    public function editMataKuliah($mk)
    {
        ...
        return view('content.mata_kuliah.edit_mata_kuliah', ['title' => 'Mata Kuliah', 'mk' => $mk, 'mks' => $mks, 'prodiList' => $prodiList,]);
    }
    ...
    public function updateMataKuliah(Request $request, $mk)
    {
        ...
        return redirect()->route('kurikulum.data.mata_kuliah')->with('success', 'Mata Kuliah berhasil diubah');
    }

    public function deleteMataKuliah($mk)
    {
        if (Mata_Kuliah::where('mat_kodeMK', $mk)->exists()) {
            return redirect()->route('kurikulum.data.mata_kuliah')->with('error', 'Mata Kuliah gagal dihapus. Mata Kuliah ini digunakan oleh Mata kuliah lain');
        } elseif (Detail_BK_MK::where('kodeMK', $mk)->exists()) {
            return redirect()->route('kurikulum.data.mata_kuliah')->with('error', 'Mata Kuliah masih berelasi dengan Bahan Kajian.');
