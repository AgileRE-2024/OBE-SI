...
class MetodeController extends Controller
{
    public function index()
    {
        ...
        return view("content.metode.metode", [
    ...
    {
        return view("content.metode.add_metode", [
    ...
    public function storeMetode(Request $request)
    {
        ...
        return redirect()
            ...
            ->with("success", "Metode pembelajaran berhasil ditambahkan");
    }
    ...
    public function edit($metode)
    {
        ...
        return view("content.metode.edit_metode", [
    ...
    public function update($metode, Request $request)
    {
        ...
        return redirect()
            ->route("kurikulum.data.metode")
            ->with("success", "Metode pembelajaran berhasil diubah");
    }
    ...
    public function delete($metode)
    {
        ...
        return redirect()
            ->route("kurikulum.data.metode")
            ->with("success", "Metode pembelajaran berhasil dihapus");
    }
}
