...
class TeknikPenilaianCPMKController extends Controller
{
    ...
    public function exportFile($tahun_ajaran, $type)
    {
        ...
        if ($type == "pdf") {
            $view = view(
                "content.teknik_penilaian_cpmk.exportpdf_teknikpenilaiancpmk",
                [
                    "list_cpl" => CPL_Prodi::all(),
                    "list_mk" => Mata_Kuliah::all(),
                    "detail_mk_cpmk" => Detail_MK_CPMK::all(),
                    "list_rps" => RPS::all()->where(
                        "tahunAjaran",
                        $tahun_ajaran
                    ),
                    "list_teknikpenilaian" => Teknik_Penilaian::all(),
            ...
            return Response::make($dompdf->output(), 200, [
                ...
                "Content-Disposition" =>
                    "inline; filename=" .
                    "Teknik Penilaian CPMK Tahun Ajaran " .
                    $tahun_ajaran .
                    "_" .
                    $date_time .
                    ".pdf",
            ...
            return Excel::download(
                new TeknikPenilaianCPMKExport($tahun_ajaran),
                "Teknik Penilaian CPMK Tahun Ajaran " .
                    $tahun_ajaran .
                    "_" .
                    $date_time .
