...
class BentukController extends Controller
{
    ...
    {
        return view("content.metode.add_bentuk", [
    ...
    public function storeBentuk(Request $request)
    {
        ...
        return redirect()
            ...
            ->with("success", "Bentuk pembelajaran berhasil ditambahkan");
    }
    ...
    public function edit($bentuk)
    {
        ...
        return view("content.metode.edit_bentuk", [
    ...
    public function update($bentuk, Request $request)
    {
        ...
        return redirect()
            ->route("kurikulum.data.metode")
            ->with("success", "Bentuk pembelajaran berhasil diubah");
    }
    ...
    public function delete($bentuk)
    {
        ...
        return redirect()
            ->route("kurikulum.data.metode")
            ->with("success", "Bentuk pembelajaran berhasil dihapus");
    }
}
