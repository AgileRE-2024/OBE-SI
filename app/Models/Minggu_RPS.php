...
class Minggu_RPS extends Model
{
    ...
    protected $fillable = [
        'kodeMingguRPS', 'id_rps', 'id_teknik_penilaian', 'id_instrumen_penilaian', 'id_komponen_penilaian', 'bobot_nilai', 'kodePenilaian', 'kodeSubCPMK', 'mingguKe','deleted_at', 'luring', 'penugasan','waktuPembelajaran','pengalaman_belajar','bahan_kajian'
    ];
